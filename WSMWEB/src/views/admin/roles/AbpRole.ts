...
import {
  RoleServiceProxy,
  PagingRoleListInput,
  PagedResultDto_1OfOfIdentityRoleDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null,
  IdentityRoleCreateDto,
  // PermissionServiceProxy, // 移除不存在的服务
  IdInput,
  GetPermissionInput,
 ...
 * @returns
 */
export async function getTableListAsync(params: PagingRoleListInput): Promise<PagedResultDto_1OfOfIdentityRoleDtoAndContractsAnd_0AndCulture_neutralAndPublicKeyToken_null | undefined> {
...
export async function getRolePermissionAsync(roleName: string) {
  // const _permissionsServiceProxy = new PermissionServiceProxy(); // 移除不存在的服务
